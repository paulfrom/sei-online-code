export default {
  ...
  '/api-gateway/sei-online-code': {
    target: 'http://192.168.0.2:8091',
    changeOrigin: true,
    secure: false,
    headers: {
      Authorization:
        // 'eyJhbGciOiJIUzUxMiJ9..oqxEoEZHylKrErUskp1dKymCtUqrSe_qSU5eDb1LKaOhwAH5qVhkA091TY8A7cR6fxNTF2vcWEK-xbbRcOL7Hw',
